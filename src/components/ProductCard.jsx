...
const ProductCard = ( { 
  ...
  return (
    <article className='pb-4 2xl:w-96 lg:w-72 md:w-60 sm:w-52 w-32'>
        <div className='flex flex-col justify-start items-start'>
        <img src={image} 
        className='cursor-pointer 2xl:w-96 lg:w-72 md:w-60 sm:w-52 w-32  2xl:h-96 lg:h-72 md:h-60 sm:h-52  h-32 object-cover pb-2 rounded-3xl'
        alt="product" />
