  ...
  return (
    <div className='mt-24'>
      <div className="bg-darkOlive max-w-full h-auto p-8">
       {/* Heading */}
      <h1 className="text-[50px] sm:text-[60px] md:text-[90px] lg:text-[150px] xl:text-[150px] text-center text-dark font-bodoni">
       Welcome to My Site  <br />  Avoron </h1>
      {/* Subheading */}
      <p className="text-xl sm:text-xl md:text-xl lg:text-3xl xl:text-5xl text-center text-dark mt-4 font-bodoni">
        Your Destination for Goddess Items
      </p>
      ...
      <h4 className="text-dark text-center mt-8 font-bodoni text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl leading-relaxed sm:leading-normal md:leading-loose">
       ...
       At My Site, we are passionate about providing a platform for women to express their unique style. <br />
     ...
     <p className="text-center font-bodoni text-dark mt-8 text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-7xl ">  My Site Way</p>
      ...
      At My Site, we are dedicated to <br /> promoting eco-friendly practices in <br />
