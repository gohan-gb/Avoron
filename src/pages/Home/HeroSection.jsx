  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6 max-w-full">
        <h1 className="text-5xl sm:text-4xl md:text-6xl lg:text-custom-lg xl:text-custom-xl font-bold  text-yellow1 mb-4">
          Avoron
        </h1>
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-yellow2 mt-8">
          Adorn the Divine with Avoron – where grace meets craftsmanship
        </h2>
        <p className="text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl text-light max-w-3xl mx-auto break-words mt-8" >
