...
const MySiteMission = () => {
  return (
    ...
    <div className='bg-olive flex flex-col justify-center items-center text-dark pb-16 '>
        ...
        <h1 className='h3 text-center pt-16 pb-16'>My Site Mission</h1>
        <p className='text-center p1 pb-16 w-[75%] sm:w-[50%]'> At My Site, we are dedicated to offering a curated selection of goddess items that embody elegance, beauty, and empowerment. Every product is chosen to reflect our commitment to quality and style.</p>
        
        <div className='pb-16 flex flex-wrap gap-10 sm:gap-20 justify-center items-center'>
            <div className='flex flex-col justify-center items-center '>
        ...
        <p className='text-center w-[75%] sm:w-[50%] pb-16'>
