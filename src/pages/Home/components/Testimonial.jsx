  ...
  return (
    <div className="mt-24">
      <div
        className="relative flex flex-col items-center justify-center h-[600px] bg-cover bg-center bg-no-repeat px-4"
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1732950575059-f5abc2110749?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
        }}
      >
       <div className="absolute top-4 w-full text-center px-4">
           <h1 className="h4 text-center">What People Say About Us</h1>
